...
let my_array = ['aRvFOku7w5I', '2HNtLfetnNg', 'nyKNwwiQYcM', 'ExQe3fXj7t8', 'i0KO9Js4_dE', 'ygqbfJOdtmA', 'gU9KRJYtg5E', 'sEL5l1dATJw', 'm8N7onAJexU'];
let currentIndex = 1;
...
$('#coin-campaign').on('shown.bs.modal', function(){
    $('iframe').attr('src', 'https://www.youtube.com/embed/' + firstVideo);
});
